...
FAQ_FILES = [
    ...
    Path(__file__).with_name("drc_man_coldroom_pricing_faq.json"),
    Path(__file__).with_name("drc_man_coldroom_design_50k_faq.json"),
    Path(__file__).with_name("drc_man_coldroom_qa_20k_faq.json"),
]
