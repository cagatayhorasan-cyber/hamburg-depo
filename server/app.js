...
} = require("./constants/troubleshooting");
const {
...
// PDF modülüne şirket profili + font path'leri inject et.
configurePdfModule({ companyProfile: COMPANY_PROFILE, pdfFonts: PDF_FONTS });
...
// NOT: queueSecurityEvent / flushQueuedSecurityEvents / enforceIpSecurityBlock /
// recordFailedAuthentication / autoBlockIfThresholdReached / activateSecurityBlock /
// findActiveSecurityBlock / normalizeSecurityEventPayload / insertSecurityEvent /
// sanitizeSecurityDetails / serializeSecurityDetails / parseSecurityDetails /
// normalizeSecuritySeverity / isFutureTimestamp tanımları
// server/lib/security-events.js + server/lib/util.js içine taşındı.
// Yukarıdaki require'lardan import ediliyorlar.
...
// NOT: querySecurityEvents / querySecurityBlocks server/lib/security-events.js'e
// taşındı (yukarıdaki require'da).
...
// NOT: numberizeRow server/lib/util.js'e taşındı (yukarıdaki require'da).

// NOT: PDF rendering (renderQuotePdf, drawQuote*, sanitizePdfText, getQuoteTranslations,
// createQuotePdfBuffer, sanitizeFileName, formatQuoteDate, configurePdfFonts vb.)
// server/lib/pdf-quote.js'e taşındı (yukarıdaki require'da).
// numberOrZero ve isTruthy server/lib/util.js'e taşındı.
